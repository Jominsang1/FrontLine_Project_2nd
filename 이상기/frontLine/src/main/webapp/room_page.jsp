...
<body>
    ...
    <div class="wrap">
        <div class="div1">
            ...
            <div class="div1 place"><h1 class="room_title"><%=RoomDB.getRoomList().get(0).getRoomTitle()%></h1></div>
			<h4 class="room_address"><%=RoomDB.getRoomList().get(0).getRoomAddress() %></h4>
            <div class="best_food">

                <div class="food_item">
					<img src="<%=RoomDB.getRoomList().get(0).getRoomImage()%>">
                </div>
            ...
            <div class="div2">
                ...
                <span class="div2 title"><%=RoomDB.getRoomList().get(0).getRoomDetail()%></span>
                <span class="div2 img"><img
