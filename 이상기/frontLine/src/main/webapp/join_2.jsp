...
<head>
    ...
    <script>
        ...
        function check_all(){
            let count = 0;
            let input_all = document.querySelectorAll(".wrap input")
            let password = document.querySelectorAll(".input_password input")
        ...
        <div class="input_main">
        	<form class="main_form" method="post" action="/frontLine/Join">
            	<div class="input_top">
                	...
                	<div class="section top input_password"><img src="resources/images/icon_password_before.png"><input type="password" placeholder="비밀번호" name="userPw"><img class="eye" src="resources/images/eye_dark.png"></div>
                	<div class="section top input_password"><img src="resources/images/icon_password_before.png"><input type="password" placeholder="비밀번호 확인" name="userPw_2"><img class="eye" src="resources/images/eye_dark.png"></div>
                	<div class="check_password">비밀번호가 일치하지 않습니다.</div>
            	</div>
            	<div class="input_bottom">
                	<div class="section input_email"><img src="resources/images/icon_message.png"><input type="text" placeholder="이메일" name="userEmail"></div>
                	<div class="section top input_phone"><img src="resources/images/icon_call.png"><input type="text" placeholder="휴대폰 번호" name="userPhone"></div>
                	<div class="section top input_birth"><img src="resources/images/icon_gift.png"><input type="text" placeholder="생년월일 8자리" name="userBirth"></div>
            	</div>
