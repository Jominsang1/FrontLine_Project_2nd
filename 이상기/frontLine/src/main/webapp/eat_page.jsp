...
%>
            <div class="div1 place"><h2 class="title"><%=EatDB.getEatList().get(pageNumber).getTitle()%></h2></div>
			
			<h4 class="address"><%=EatDB.getEatList().get(pageNumber).getAddress() %></h4>
			<h5><%=EatDB.getEatList().get(pageNumber).getOpenTime() %></h5>
			<h5><%=EatDB.getEatList().get(pageNumber).getTell() %></h5>
            <div class="best_food">
			
                <div class="food_item">
					<img src="<%=EatDB.getEatList().get(pageNumber).getImage()%>">
                </div>
            ...
            <div class="div2">
                ...
                <span class="div2 title"><%=EatDB.getEatList().get(pageNumber).getDetail()%></span>
                <span class="div2 img"><img
